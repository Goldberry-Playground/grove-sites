...
// Backend-only secrets for the Goldberry tenant. Importing this module from a
// `"use client"` file is a build-time error thanks to `server-only`, so these
...
export const tenantSecrets = {
  ...
  ghostUrl: requireEnv("GHOST_URL", "http://localhost:2368"),
