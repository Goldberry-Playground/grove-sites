...
// This app is the Goldberry Grove farm site — an absent brand defaults to its own list.
const DEFAULT_BRAND: Brand = "goldberry";
...
export async function POST(req: Request) {
  ...
  try {
    request = validateOptIn({
      ...
      brand: (payload.brand as Brand) ?? DEFAULT_BRAND,
